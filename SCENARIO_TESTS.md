# PST Testing Scenarios for Fishbowl Inventory Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_fishbowl_inventory_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_fishbowl_inventory_connector` without lingering secrets.
