"""Settings panel for Fishbowl Inventory Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__fishbowl_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=fishbowl_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_fishbowl"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Fishbowl Inventory Settings & Accounts", level=2),
